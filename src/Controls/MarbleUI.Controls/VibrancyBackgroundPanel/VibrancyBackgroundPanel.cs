...
{
    public class VibrancyBackgroundPanel : Control
    {
        public static readonly StyledProperty<ExperimentalAcrylicMaterial> MaterialProperty = AvaloniaProperty.Register<VibrancyBackgroundPanel, ExperimentalAcrylicMaterial>(
            "Material");
        ...
        static VibrancyBackgroundPanel()
        {
            AffectsRender<VibrancyBackgroundPanel>(MaterialProperty);
        }
